...
ALTER TABLE [dbo].[Employee] WITH NOCHECK
    ADD CONSTRAINT [EMP_MNGR_KEY] FOREIGN KEY ([Manager_id]) REFERENCES [dbo].[Employee] ([Employee_id]) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE [dbo].[Store] WITH NOCHECK
    ADD CONSTRAINT [STR_MNGR_KEY] FOREIGN KEY ([Manager_id]) REFERENCES [dbo].[Employee] ([Employee_id]) ON DELETE CASCADE ON UPDATE CASCADE;
